                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-start"
                                                    ...
                                                    <a class="dropdown-item text-end"
                                                        href="{{ route('admin.Page.Model', ['id' => $Page->id, 'view' => 'Show']) }}"><i
                                                            class="fa fa-eye text-black-50 mx-2"></i>عرض</a>
                                                    <a class="dropdown-item text-end"
                                                        href="{{ route('admin.Page.Model', ['id' => $Page->id, 'view' => 'Edit']) }}"><i
                                                            class="fa fa-pen text-black-50 mx-2"></i>تعديل</a>
                                                    <a class="dropdown-item text-end"
                                                        onclick="return confirm('هل انت متأكد من رغبتك بالحذف؟')"
                                                        href="{{ route('admin.Page.ParmentlyDelete', ['id' => $Page->id]) }}"><i
