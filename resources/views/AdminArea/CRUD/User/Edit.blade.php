...
@section('content')
    <div class="d-flex flex-column w-100 align-items-center justify-content-center mt-4">
        ...
        @endif
        <form method="POST" action="{{ route('admin.User.Update') }}" class="w-75" enctype="multipart/form-data">
            @csrf
            ...
            @if ($user->type == 'restaurant')
                <div class="form-floating mb-3">
                    <img src="{{ asset('images/' . $user->photo) }}" alt="" class="img-fluid"
                ...
                <div class="form-floating mb-3">
                    ...
                    <input type="number" max="100" value="{{ $user->fee }}"
                        class="form-control @error('fee') is-invalid @enderror" name="fee" required autofocus>
                ...
                <div class="form-floating mb-3">
                    ...
                    <input type="number" max="100" value="{{ $user->opening }}"
                        class="form-control @error('opening') is-invalid @enderror" name="opening" required autofocus>
                ...
                <div class="form-floating mb-3">
                    ...
                    <input type="number" max="100" value="{{ $user->clothing }}"
                        class="form-control @error('clothing') is-invalid @enderror" name="clothing" required autofocus>
