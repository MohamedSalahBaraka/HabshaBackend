...
@section('content')
    <div class="d-flex w-100 flex-column align-items-center justify-content-center mt-4">
        ...
        @endif
        <form method="POST" action="{{ route('admin.Category.Update') }}" class="w-75" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-floating mb-3">
                <img src="{{ asset('images/' . $category->photo) }}" alt="" class="img-fluid"
